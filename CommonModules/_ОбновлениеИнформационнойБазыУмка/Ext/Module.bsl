...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
    ...
    ////кп никитина .заполнение идшников 

    //Обработчик = Обработчики.Добавить();
    //Обработчик.РежимВыполнения = "Отложенно";
    //Обработчик.Версия = "*";
    //Обработчик.Комментарий = НСтр("Заполнение ид задач");
    //
    //Обработчик.Процедура = "_ОбщийМодульСервер.ЗаполнитьИДЗаданий";
    //
    //кп никитина создание бп из заданий
    //Обработчик = Обработчики.Добавить();
    //Обработчик.РежимВыполнения = "Отложенно";
    //Обработчик.Версия = "2.0.3.5";
    //Обработчик.МонопольныйРежим = Ложь;
    //Обработчик.ЧитаемыеОбъекты = "Документ._Заявка";
    //Обработчик.ИзменяемыеОбъекты = "БизнесПроцесс._ЗадачиПоЗаявкам,Задача._ИсполнениеЗадач";         
    //Обработчик.Комментарий = НСтр("Создание задач");
    //Обработчик.Процедура = "_ОбщийМодульСервер.СоздатьЗадачиИБП";
    //Обработчик.Приоритет = 1; 
    //Обработчик.ВыполнятьВГруппеОбязательных = Истина; 

    Если Метаданные.Версия = "2.0.3.6" тогда
        _ОбщийМодульСервер.СоздатьЗадачиИБП();    
    КонецЕсли;
